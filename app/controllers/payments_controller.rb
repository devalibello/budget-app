class PaymentsController < ApplicationController
  ...
  def index
    @payments = Payment.includes(:categories).where(category_id: params[:category_id])
  ...
  def create
    ...
    @payment.categories << Category.where(id: @payment.category_id.to_s) if @payment.save
